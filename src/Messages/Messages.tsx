...
import { AUCTION_HOUSE_PROGRAM_ID, AUCTION_HOUSE_ADDRESS } from '../utils/auctionHouse/helpers/constants';
...
function AuthedHome() {
    ...
    React.useEffect(() => setWallet(connected(wallet) ? wallet : null), [setWallet, wallet, isWalletConnected]);
