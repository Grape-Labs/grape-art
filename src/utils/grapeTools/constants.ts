...
export const RPC_ENDPOINT = QUICKNODE_RPC_ENDPOINT || HELLO_MOON_ENDPOINT || SHYFT_RPC_ENDPOINT || 'https://api.mainnet-beta.solana.com';
...
export const MARKET_LOGO = STATIC_LOGO; //'../../public/grape_white_logo.svg";//STATIC_LOGO;
