...
//import { useAnchorWallet } from "@solana/wallet-adapter-react";
  ...
  export async function createProposal(offerAmount: number, mint: string, walletPublicKey: string, mintOwner: any, weightedScore: any, daoPublicKey: string, connection: Connection, transactionInstr: InstructionsAndSignersSet, sendTransaction: any, wallet: WalletSigner): Promise<PublicKey> {
    ...
    console.log('daoPublicKey:', daoPublicKey);
    ...
    //console.log('instructions length:', transactionInstr.instructions.length);
