  ...
  *
  * @property [_writable_] metadata Metadata (pda of ['metadata', program id, mint id]) // doing this in identity should push same implementation here
  * @property [_writable_, **signer**] owner NFT owner // owner
  * @property [_writable_] mint Mint of the NFT // mint address
